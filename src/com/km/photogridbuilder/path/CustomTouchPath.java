...
public class CustomTouchPath
{
    public static interface CommonListener
    {
        ...
        public abstract void getPositionAndScale(Object obj, ImageObjectPath.PositionAndScale positionandscale);

        public abstract void onDoubleTap(Object obj, PointInfo pointinfo);

        public abstract void selectObject(Object obj, PointInfo pointinfo);

        public abstract boolean setPositionAndScale(Object obj, ImageObjectPath.PositionAndScale positionandscale, PointInfo pointinfo);
    }
    ...
    private ImageObjectPath.PositionAndScale mCurrXform;
    private int mMode;
    ...
    public CustomTouchPath(CommonListener commonlistener)
    {
        this(commonlistener, true);
    }

    public CustomTouchPath(CommonListener commonlistener, boolean flag)
    {
        selectedObject = null;
        mCurrXform = new ImageObjectPath.PositionAndScale();
        mMode = 0;
