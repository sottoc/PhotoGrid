...
public class ImageObjectPath
{
    ...
    public ImageObjectPath(Bitmap bitmap1, Resources resources)
    {
        mUIMode = 1;
        fixed = false;
        paint = new Paint();
    ...
    public void load(Resources resources, RectF rectf, Path path)
    {
        float f;
        float f1;
        float f2;
