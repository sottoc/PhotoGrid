...
//            AddButton, TextObject, Image

public class StickerView extends View
    implements com.km.photogridbuilder.bean.CustomTouch.CommonListener
{
    ...
    public static interface TapListener
    {
        ...
        public abstract void onDoubleTapListener(Object obj, com.km.photogridbuilder.bean.CustomTouch.PointInfo pointinfo);
    }
    ...
    private com.km.photogridbuilder.bean.CustomTouch.PointInfo currTouchPoint;
    ...
    public StickerView(Context context, AttributeSet attributeset, int i)
    {
        ...
        currTouchPoint = new com.km.photogridbuilder.bean.CustomTouch.PointInfo();
        mShowDebugInfo = true;
        mUIMode = 1;
        mPaint = new Paint();
        gapRect = new RectF();
    ...
    public Object getDraggableObjectAtPoint(com.km.photogridbuilder.bean.CustomTouch.PointInfo pointinfo)
    {
        float f;
        float f1;
        int i;
        ...
        while(j >= 0){
            ...
            if(!(obj instanceof TextObject)){
    	        ...
    	        if(((TextObject)obj).containsPoint(f, f1))
    	        	return obj;
            }
            j--;
        }
        ...
        while(k >= 0){
        	obj = mImages.get(k);
            if((obj instanceof Image) && ((Image)obj).containsPoint(f, f1))
            	return obj;
            k--;
        }
        return obj;
    ...
    public void getPositionAndScale(Object obj, Image.PositionAndScale positionandscale)
    {
        ...
        if(obj instanceof ImageObject)
        {
            ...
            float f5 = imageobject.getCenterX();
            float f6 = imageobject.getCenterY();
            boolean flag3;
            float f7;
            boolean flag4;
            float f8;
            ...
            f7 = (imageobject.getScaleX() + imageobject.getScaleY()) / 2.0F;
            if((2 & mUIMode) != 0)
            {
                flag4 = true;
            } else
            ...
            f8 = imageobject.getScaleX();
            f9 = imageobject.getScaleY();
            j = 1 & mUIMode;
            flag5 = false;
            if(j != 0)
            {
            ...
            positionandscale.set(f5, f6, flag3, f7, flag4, f8, f9, flag5, imageobject.getAngle());
            return;
        }
    ...
    public void loadImages(Context context, RectF rectf)
    {
        ...
        if(rectf == null)
        {
            if(mImages.get(i - 1) instanceof Image)
            {
        ...
        if(mImages.get(i - 1) instanceof Image)
        {
            ((Image)mImages.get(i - 1)).load(resources, rectf);
            return;
        } else
        {
    ...
    public void loadImages(Context context, boolean flag, int ai[])
    {
        ...
        if(flag)
        {
            ...
            {
                ((ImageObject)mImages.get(i - 1)).load(resources, ai);
            }
        } else
        {
            int j = 0;
            ...
            {
                if(mImages.get(j) instanceof ImageObject)
                {
                    if(((ImageObject)mImages.get(j)).isSticker() || mImages.size() == j + 1)
                    {
    ...
    public void onDoubleTap(Object obj, com.km.photogridbuilder.bean.CustomTouch.PointInfo pointinfo)
    {
        mListener.onDoubleTapListener(obj, pointinfo);
    }
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        while(j < i){
        	try
            {
                if(mImages.get(j) instanceof Image)
                {
        ...
        if(mbitmap != null){
	        ...
	        if(!(isSaveClicked || isButtonSet)){
		        af = Constant.getArrayForLayout(layout);
		        i1 = 0;
		        while(i1 < af.length){
		        	float f3 = af[i1][0];
		            float f4 = af[i1][1];
        ...
        while(k < i){
            ...
            if(mImages.get(k) instanceof ImageObject)
            {
                ((ImageObject)mImages.get(k)).draw(canvas);
            }
            k++;
        }
        Iterator iterator = mDrawingList.iterator();
        while(true){
	        if(!iterator.hasNext())
	        {
    ...
    public void selectObject(Object obj, com.km.photogridbuilder.bean.CustomTouch.PointInfo pointinfo)
    {
    ...
    public boolean setPositionAndScale(Object obj, Image.PositionAndScale positionandscale, com.km.photogridbuilder.bean.CustomTouch.PointInfo pointinfo)
    {
        currTouchPoint.set(pointinfo);
        boolean flag;
        if(obj instanceof ImageObject)
        ...
        {
            flag = ((Image)obj).setPos(positionandscale);
        } else
        {
