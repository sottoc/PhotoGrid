...
public class ColorPickerPreference extends DialogPreference implements ColorPickerView.OnColorChangedListener{
	...
	private void init(AttributeSet attrs) {
		final int[] ColorPickerPreference = {
	            0x7f010000, 0x7f010001
	        };
		final int[] ColorPickerView = {
	            0x7f010002, 0x7f010003, 0x7f010004, 0x7f010005
	        };
		
		TypedArray a = getContext().obtainStyledAttributes(attrs, ColorPickerPreference);
		
		showDialogTitle = a.getBoolean(0, false);
		showPreviewSelectedColorInList = a.getBoolean(1, true);
		
		a.recycle();	
		a = getContext().obtainStyledAttributes(attrs, ColorPickerView);
		
		alphaChannelVisible = a.getBoolean(0, false);
		alphaChannelText = a.getString(1);		
		colorPickerSliderColor = a.getColor(2, -1);
		colorPickerBorderColor = a.getColor(3, -1);
