...
public class ColorPickerView extends View{
	...
	private void init(AttributeSet attrs) {
		...
		TypedArray a = getContext().obtainStyledAttributes(attrs, ColorPickerView);		
		mShowAlphaPanel = a.getBoolean(0, false);
		mAlphaSliderText = a.getString(1);		
		mSliderTrackerColor = a.getColor(2, 0xFFBDBDBD);
		mBorderColor = a.getColor(3, 0xFF6E6E6E);
		a.recycle();
